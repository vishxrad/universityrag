...
vault_content = []
if os.path.exists("vault2.txt"):
    with open("vault2.txt", "r", encoding='utf-8') as vault_file:
...
# Convert embeddings to tensor and print embeddings
print("Converting embeddings to tensor...")
vault_embeddings_tensor = ipex.optimize(torch.tensor(vault_embeddings)) 
